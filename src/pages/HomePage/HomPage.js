...
import twitterIcon from "../../images/twiter.svg";
import youtubeIcon from "../../images/youtube.svg";
import instagramIcon from "../../images/instargram.svg";
      ...
      <main>
        <section className="home_top_section banner">
          <div className="home_top_div">
            ...
            <img className="home_img_top" src={imgHomeTop} alt="판다" />
          </div>
        </section>

        <section className="home_section container">
          <div className="home_div">
            <img className="home_img" src={imgHome01} alt="인기 상품" />
            <div className="text">
        ...
        <section className="home_section container section_search">
          <div className="home_div div_search">
            ...
            <img className="home_img" src={imgHome02} alt="상품 검색" />
          </div>
        </section>

        <section className="home_section container">
          <div className="home_div">
            <img className="home_img" src={imgHome03} alt="상품 등록" />
            <div className="text">
        ...
        <section className="home_bottom_section banner">
          <div className="home_bottom_div">
            ...
            <img className="home_img_bottom" src={imgHomeBottom} alt="판다" />
          </div>
        </section>
      </main>
      ...
      <footer>
        ...
        <div className="footer_icon">
          ...
          <a href="https://www.instagram.com/">
            <img className="instargram" src={instagramIcon} alt="Instagram" />
          </a>
        </div>
      </footer>
    </div>
